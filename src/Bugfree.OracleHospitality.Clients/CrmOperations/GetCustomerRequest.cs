...
{
    public class GetCustomerRequest : CrmRequest
    {
        public string Conditions { get; }
        public ColumnValue[] ColumnValues { get; }
        public Column[] Columns { get; }

        public GetCustomerRequest(string requestSourceName, string conditions, ColumnValue[] columnValues, Column[] columns)
