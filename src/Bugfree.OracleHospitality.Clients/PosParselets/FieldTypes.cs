...
namespace Bugfree.OracleHospitality.Clients.PosParselets
{
    static class FieldTypes
    {
        ...
        private static readonly Regex A3 = new Regex(A3Pattern, RegexOptions.Compiled);
        private static readonly Regex A5 = new Regex(A5Pattern, RegexOptions.Compiled);
        private static readonly Regex A8 = new Regex(A8Pattern, RegexOptions.Compiled);
        private static readonly Regex A16 = new Regex(A16Pattern, RegexOptions.Compiled);
        private static readonly Regex A24 = new Regex(A24Pattern, RegexOptions.Compiled);
        private static readonly Regex A25 = new Regex(A25Pattern, RegexOptions.Compiled);
        private static readonly Regex A32 = new Regex(A32Pattern, RegexOptions.Compiled);
        private static readonly Regex A100 = new Regex(A100Pattern, RegexOptions.Compiled);
        private static readonly Regex A128 = new Regex(A128Pattern, RegexOptions.Compiled);
        private static readonly Regex N2 = new Regex(N2Pattern, RegexOptions.Compiled);
        private static readonly Regex N4 = new Regex(N4Pattern, RegexOptions.Compiled);
        private static readonly Regex N9 = new Regex(N9Pattern, RegexOptions.Compiled);

        private static readonly Regex Decimal = new Regex(DecimalPattern, RegexOptions.Compiled);
        private static readonly Regex Date = new Regex(DatePattern, RegexOptions.Compiled);
        private static readonly Regex Time = new Regex(TimePattern, RegexOptions.Compiled);
